...
/**
 * Builds level 2: enemies (Pufferfish/Jellyfish plus the Finalboss), coins,
...
export function createLevl2() {
    return new Level(
    [
        new Pufferfish(500, 250, 1),
        new Jellyfish(1009, 150, 1),
        new Pufferfish(1518, 350, 1),
        new Jellyfish(2027, 100, 1),
        new Pufferfish(2536, 300, 1),
        new Jellyfish(3045, 200, 1),
        new Pufferfish(3554, 280, 1),
        new Jellyfish(4063, 120, 1),
        new Pufferfish(4572, 320, 1),
        new Jellyfish(5081, 180, 1),
        new Pufferfish(5590, 260, 1),
